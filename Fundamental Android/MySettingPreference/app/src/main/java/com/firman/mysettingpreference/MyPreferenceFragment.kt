package com.firman.mysettingpreference
...
class MyPreferenceFragment : PreferenceFragmentCompat(),
    ...
    private fun init() {
        ...
        isLoveRmPreference = findPreference<CheckBoxPreference> (LOVE) as CheckBoxPreference
    }

    private fun setSummaries() {
        val sh = preferenceManager.sharedPreferences ?: return
        ...
        isLoveRmPreference.isChecked = sh.getBoolean(LOVE, false)
    }
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences, key: String?) {
        ...
        if (key == LOVE) {
            isLoveRmPreference.isChecked = sharedPreferences.getBoolean(LOVE, false)
        }
    }
}